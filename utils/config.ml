...
let ocamlc_cppflags = "-D_FILE_OFFSET_BITS=64 -D_REENTRANT -I/usr/local/opt/expat/include"
...
let ocamlopt_cppflags = "-D_FILE_OFFSET_BITS=64 -D_REENTRANT -I/usr/local/opt/expat/include"
...
let mkdll, mkexe, mkmaindll =
  ...
  if Sys.os_type = "Win32" then
    try
      ...
      flexlink ^ " -maindll"
    with Not_found ->
      "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -Wdeclaration-after-statement -fno-common   -Wl,-no_compact_unwind", "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
  else
    "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind", "gcc -O2 -fno-strict-aliasing -fwrapv -Wall -Wdeclaration-after-statement -fno-common   -Wl,-no_compact_unwind", "gcc -shared -flat_namespace -undefined suppress                    -Wl,-no_compact_unwind"
...
let host = "x86_64-apple-darwin20.6.0"
let target = "x86_64-apple-darwin20.6.0"
